...
data %>% 
  ggplot(aes(avg_height_at_phys_maturity, fill = location))+
...
ggsave("figure/plant_heigh/avg_height_at_phys_maturity_modeling.png", width = 8, height = 5, dpi = 600)
```
...
ph1 <- lsd_test_01_mod(data %>% 
  ...
  labs(x= "", y = "Plant heigh (cm)", title = "Vermilion")
ph1
ggsave("figure/plant_heigh/plant_heigh_Vermilion_year.png", width = 10, height = 5, dpi = 600)
```
...
p3_1 <- lsd_test_02_mod(data_plant_h %>% 
 ...
 theme(plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(vjust = 0.5)) +labs(x = NULL, y = NULL)+
  labs(x= "", y = "Plant height (cm)", title = "Falher", fill = "Variety")
p3_1
...
p4 <- lsd_test_01(data_plant_h %>% 
  ...
  labs(x= "", y = "Plant height (cm)", title = "Vermilion")+
  ylim(0,80)+
  coord_flip()
p4
...
p4_1 <- lsd_test_02(data_plant_h %>% 
  ...
  theme(plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(vjust = 0.5)) +labs(x = NULL, y = NULL)+
  labs(x= "", y = "Plant height (cm)", title = "Vermilion", fill = "Year")+
   coord_flip()
p4_1
...
p5 <- lsd_test_01(data_plant_h %>% 
  ...
  labs(x = NULL, y = NULL)+
  labs(x= "", y = "Plant height (cm)", title = "Lethbridge")+
   coord_flip()
p5
...
p5_1 <- lsd_test_02(data_plant_h %>% 
  ...
  theme(plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(vjust = 0.5)) +labs(x = NULL, y = NULL)+
  labs(x= "", y = "Plant height (cm)", title = "Lethbridge", fill = "Year")+
  coord_flip()
p5_1
...
p6 <- lsd_test_01(data_plant_h %>% 
  ...
  theme(plot.title = element_text(hjust = 0.5),
        ...
        axis.text.y = element_blank(),
    axis.text.x = element_text(vjust = 0.5)) +labs(x = NULL, y = NULL)+
  labs(x= "", y = "Plant height (cm)", title = "Falher")
p6
